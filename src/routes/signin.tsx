...
export function SignInPage() {
  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center p-4">
      <div className="glass-strong relative w-full max-w-md rounded-2xl p-8 shadow-2xl border border-border/50">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-mono text-sm font-semibold tracking-tight">Master Framework Access</p>
          </div>
        </div>
          ...
          <TabsContent value="signin" className="mt-4">
            <form onSubmit={signIn} className="space-y-3.5">
              ...
              <Button
                type="submit"
                disabled={busy}
                className="w-full font-mono text-xs uppercase tracking-widest cursor-pointer"
              >
