...
export const PHILOSOPHY = {
  ...
  deliveryModel:
    "Hybrid Venture Studio Model — classroom + venture studio + founder mentoring + industry interactions + product building + customer validation + real-world experimentation.",
  corePhilosophy: [
...
export const TLOS_FULL = [
  {
    ...
    description:
      "Identify meaningful problems, distinguish painkillers vs vitamins, understand market gaps, validate whether a problem is worth solving.",
    demonstration: [
      "Customer interviews",
      "Field observations",
      "Problem statements",
  ...
  },
  {
    ...
    description:
      "Identify ICPs, conduct structured user interviews, analyze customer behavior, validate assumptions, interpret qualitative & quantitative feedback.",
    demonstration: [
      "Conduct interviews",
      "Collect responses",
      "Analyze patterns",
  ...
  },
  {
    ...
    description:
      "Define MVP scope, avoid overbuilding, prioritize features, design solution hypotheses, map user flows.",
    demonstration: [
      "Build MVPs",
      "Define feature priorities",
      "Create workflows",
      "Show execution reasoning",
    ],
  },
  {
    id: "TLO-4",
    ...
    description:
      "Execute under uncertainty, iterate rapidly, respond to user feedback, improve products systematically.",
    demonstration: [
      "Maintain iteration logs",
  ...
  },
  {
    ...
    description:
      "Understand GTM fundamentals, identify distribution channels, understand positioning, test acquisition, develop launch strategies.",
    demonstration: [
      "Attempt distribution",
      "Run outreach",
      "Conduct experiments",
      "Measure traction indicators",
    ],
  },
  {
    id: "TLO-6",
    ...
    demonstration: [
      "Define pricing rationale",
      "Estimate viability",
      "Explain unit economics",
      "Justify monetization",
    ],
  },
  {
    id: "TLO-7",
    ...
    description:
      "Communicate ideas clearly, pitch products, explain traction, defend assumptions, answer critical questions.",
  ...
  },
  {
    ...
    description:
      "Interpret data, distinguish vanity vs signal, identify execution bottlenecks, make evidence-backed decisions.",
    demonstration: [
      "Interpret metrics",
      "Analyze user behavior",
      "Explain pivots",
      "Justify strategic choices",
    ],
  },
  {
    id: "TLO-9",
    ...
    description:
      "Work in venture teams, manage accountability, distribute ownership, resolve conflicts, contribute meaningfully.",
    demonstration: [
      "Show contribution evidence",
      "Execution logs",
  ...
  },
  {
    ...
    description:
      "Recover from failed assumptions, pivot intelligently, identify repeated mistakes, adapt strategies after setbacks.",
    demonstration: [
      "Explain failed experiments",
      "Recovery attempts",
      "Pattern correction",
      "Lessons learned",
    ],
...
export const COMPETENCY_CLUSTERS = [
  {
    ...
    items: ["Initiative", "Ownership", "Ambiguity handling", "Resilience", "Accountability"],
  },
  {
    id: "B",
    name: "Product & Customer Thinking",
    items: ["User understanding", "Product framing", "Validation", "Experimentation", "Iteration"],
  },
  {
    id: "C",
    name: "Venture Execution",
    items: ["MVP building", "Launch execution", "GTM testing", "Traction building", "Operations"],
  },
  {
    id: "D",
    name: "Analytical Decision-Making",
    items: ["Metrics interpretation", "Problem solving", "Strategic analysis", "Prioritization"],
  },
  {
    id: "E",
...
export const SEMESTERS: SemesterData[] = [
  {
    ...
    objective:
      "Shift students from passive academic thinking toward active problem-oriented thinking. Identify meaningful problems, understand users, conduct customer conversations, frame startup opportunities.",
    outcomes: [
    ...
    modules: [
      {
        ...
        topics: [
          ...
          "Startup vs business vs freelancing",
          "Venture lifecycle",
          "Why startups fail",
          "Startup ecosystems",
          "Founder psychology",
      ...
      {
        id: "M6",
        title: "Communication & Pitching Basics",
        topics: [
    ...
    labs: [
      {
        id: "L1",
        title: "Problem Observation Exercise",
        description: "Document frustrations, inefficiencies, repetitive pain points.",
      },
      {
        id: "L2",
        title: "Customer Interview Sprint",
        description: "Conduct 15–25 customer interviews in the field.",
      },
      {
        id: "L3",
        title: "ICP Mapping",
        description: "Define target audience, behavior, demographics, psychographics.",
      },
      {
        id: "L4",
        title: "Problem Validation Report",
        description: "Submit validation evidence, interview synthesis, opportunity analysis.",
      },
      {
        id: "L5",
        title: "Founder Reflection Journal",
        description: "Maintain execution logs, learning logs, founder reflections.",
      },
    ],
    evaluation: [
    ...
    failureConditions: [
      ...
      "Validation lacks evidence",
    ],
    tloMap: ["TLO-1", "TLO-2", "TLO-7", "TLO-9"],
    faculty: [
      "Track Lead — Founder pedagogy",
      "Lecturer — Entrepreneurship fundamentals",
      "Lab Mentor — Field interview supervision",
      "Industry Mentor — Founder stories",
    ],
  ...
  },
  {
    ...
    objective:
      "Convert validated problems into usable solutions. Learn MVP thinking, experimentation, prototyping, iteration, and early execution systems.",
    outcomes: [
      "Define MVP scope",
      "Prioritize features",
      "Build prototypes",
    ...
    modules: [
      ...
      },
      {
        ...
        topics: ["No-code tools", "Rapid prototyping", "Functional demos", "Workflow testing"],
      },
      {
        id: "M5",
      ...
      {
        id: "M6",
        title: "Team Dynamics & Execution",
        topics: [
          "Startup team structures",
          "Founder conflict",
    ...
    labs: [
      {
        ...
        description: "Define must-have features, excluded features, launch constraints.",
      },
      {
        id: "L2",
        title: "Prototype Sprint",
        description: "Build clickable MVP, functional prototype, demo workflow.",
      },
      {
        id: "L3",
        title: "Validation Experiment",
        description: "Conduct user tests, onboarding attempts, usability reviews.",
      },
      {
        id: "L4",
        title: "Iteration Sprint",
        description: "Modify product, document changes, explain reasoning.",
      },
      {
        id: "L5",
        title: "MVP Review Day",
        description: "Present MVP, assumptions, validation evidence, next steps.",
      },
    ],
    evaluation: [
  ...
  },
  {
    ...
    objective:
      "Transition from building to distribution and market testing. Focus on launching, onboarding, acquisition, analytics, traction, retention.",
    outcomes: [
    ...
    modules: [
      ...
      },
      {
        ...
        topics: ["Community building", "SEO basics", "Social distribution", "Startup storytelling"],
      },
      {
        id: "M3",
      ...
      },
      {
        ...
        topics: ["Vanity vs signal", "Retention", "Engagement", "Funnel analysis"],
      },
      {
        id: "M5",
      ...
      },
      {
        ...
        topics: ["Weekly planning", "Execution systems", "Sprint structures", "Prioritization"],
      },
    ],
    labs: [
      {
        ...
        description: "Public launch with onboarding flow and feedback collection.",
      },
      {
        id: "L2",
        title: "GTM Experimentation",
        description: "Run multiple channel experiments and document CAC signals.",
      },
      {
        id: "L3",
        title: "Analytics Tracking",
        description: "Instrument funnel, define north-star metric, weekly review.",
      },
      {
        id: "L4",
        title: "Funnel Optimization",
        description: "Identify drop-offs, test fixes, measure lift.",
      },
      {
        id: "L5",
        title: "User Retention Review",
        description: "Cohort retention analysis and re-engagement experiments.",
      },
      {
        id: "L6",
        title: "Founder Demo Day",
        description: "Public demo with traction story and live Q&A.",
      },
    ],
    evaluation: [
  ...
  },
  {
    ...
    objective:
      "Learn operationalization, startup systems, pricing, startup finance, scaling logic, investor communication.",
    outcomes: [
    ...
    modules: [
      {
        ...
        topics: ["SOPs", "Startup operations", "Internal systems", "Scaling constraints"],
      },
      {
        id: "M2",
        title: "Finance & Unit Economics",
        topics: ["CAC", "LTV", "Burn", "Revenue models", "Runway"],
      },
      {
        id: "M3",
      ...
      },
      {
        ...
        topics: ["Founder burnout", "Decision-making", "Leadership", "Team culture"],
      },
      {
        id: "M5",
        title: "Scale & Expansion",
        topics: ["Scaling operations", "Hiring", "Delegation", "Product expansion"],
      },
    ],
    labs: [
      {
        id: "L1",
        title: "Venture Audit",
        description: "Full audit of venture systems, ops, and metrics.",
      },
      { id: "L2", title: "Founder Pitch Day", description: "Investor-style pitch and Q&A." },
      {
        id: "L3",
        title: "Startup Systems Review",
        description: "Document SOPs and operational gaps.",
      },
      {
        id: "L4",
        title: "Pricing Simulation",
        description: "Test pricing variants on live or simulated customers.",
      },
      {
        id: "L5",
        title: "Investor Simulation",
        description: "Mock diligence with investor mentors.",
      },
      {
        id: "L6",
        title: "Final Venture Defense",
        description: "Defend venture trajectory, decisions, learnings.",
      },
    ],
    evaluation: [
    ...
    successMetrics: [
      ...
      "Final venture defense",
    ],
    failureConditions: [
      "No systems",
      "Unjustified economics",
      "No fundraising readiness",
      "Defense fails",
    ],
...
export const WEEKS: WeekEntry[] = [
    ...
    sessions: [
      {
        ...
        bullets: [
          ...
          "Startup vs business vs freelancing",
          "Why startups fail",
          "Reality of startup ecosystems",
          "Myths around entrepreneurship",
        ],
      },
      {
        id: "Session 2",
    ...
    labs: [
      {
        id: "Lab 1",
        bullets: [
          "Founder self-assessment: interests, strengths, risk appetite, curiosity mapping",
        ],
      },
      {
        id: "Lab 2",
        bullets: [
          "Startup ecosystem exploration: Indian startups, failed startups, unicorns, bootstrapped",
        ],
      },
    ],
    ...
    sessions: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Observational entrepreneurship",
          "Behavioral problem mapping",
          "Local problem ecosystems",
        ],
      },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Identify 25 frustrations in daily life"] },
      {
        id: "Lab 2",
        bullets: [
          "Problem observation exercise: document inefficiencies, delays, repetitive pain points",
        ],
      },
    ],
  ...
  },
  {
    ...
    sessions: [
      {
        id: "Session 1",
        bullets: ["Customer empathy", "Listening vs pitching", "Identifying emotional pain points"],
      },
      {
        id: "Session 2",
        bullets: ["Organizing interview data", "Identifying patterns", "Qualitative synthesis"],
      },
    ],
    labs: [
  ...
  },
  {
    ...
    sessions: [
      {
        id: "Session 1",
        bullets: ["Market sizing basics", "TAM/SAM/SOM", "Existing alternatives"],
      },
      {
        id: "Session 2",
        bullets: ["Competitive analysis", "Why competitors matter", "Behavioral segmentation"],
      },
    ],
    labs: [
  ...
  // S1 weeks 6–16 condensed (themes preserved)
  {
    week: 6,
    semester: "S1",
    title: "Startup Ideation Systems",
    sessions: [
      {
        id: "Session 1",
        bullets: ["Idea generation systems", "Problem-first startups", "Founder-market fit"],
      },
      {
        id: "Session 2",
        bullets: ["Opportunity selection", "Hypothesis framing", "Decision filters"],
      },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Generate 50 ideas → shortlist 5"] },
      { id: "Lab 2", bullets: ["Hypothesis canvas per idea"] },
    ],
    deliverables: ["Idea Shortlist", "Hypothesis Canvas"],
    evaluationFocus: [{ metric: "Originality", focus: "Non-obvious framing" }],
  },
  {
    week: 7,
    semester: "S1",
    ...
    sessions: [
      {
        id: "Session 1",
        bullets: ["Selection criteria", "Effort vs impact", "Founder-market fit deep dive"],
      },
      { id: "Session 2", bullets: ["Sequencing experiments", "Killing weak ideas"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Score shortlisted ideas"] },
      { id: "Lab 2", bullets: ["Pick primary venture direction"] },
    ],
    deliverables: ["Selection Memo"],
    evaluationFocus: [{ metric: "Reasoning", focus: "Evidence-based" }],
  },
  {
    week: 8,
    semester: "S1",
    title: "Behavioral Insight Synthesis",
    sessions: [
      { id: "Session 1", bullets: ["Behavioral patterns", "JTBD basics"] },
      { id: "Session 2", bullets: ["Workflow mapping", "Jobs vs tasks"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["JTBD interviews"] },
      { id: "Lab 2", bullets: ["Workflow diagrams"] },
    ],
    deliverables: ["JTBD Document"],
    evaluationFocus: [{ metric: "Synthesis", focus: "Pattern depth" }],
  },
  {
    week: 9,
    semester: "S1",
    ...
    sessions: [
      { id: "Session 1", bullets: ["Validation frameworks", "Disconfirming evidence"] },
      { id: "Session 2", bullets: ["Validation reports", "Storytelling with evidence"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Run validation experiments"] },
      { id: "Lab 2", bullets: ["Synthesize findings"] },
    ],
    deliverables: ["Problem Validation Report"],
    evaluationFocus: [{ metric: "Evidence", focus: "Authenticity" }],
  },
  {
    week: 10,
    semester: "S1",
    ...
    sessions: [
      { id: "Session 1", bullets: ["Narrative building", "Audience empathy"] },
      { id: "Session 2", bullets: ["Slide structure", "Verbal clarity"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["3-min idea pitch drills"] },
      { id: "Lab 2", bullets: ["Peer critique"] },
    ],
    deliverables: ["Pitch Draft"],
    evaluationFocus: [{ metric: "Clarity", focus: "Audience adaptation" }],
  },
  {
    week: 11,
    semester: "S1",
    title: "Pitching Basics",
    sessions: [
      { id: "Session 1", bullets: ["Pitch anatomy", "Problem-solution arc"] },
      { id: "Session 2", bullets: ["Handling Q&A", "Defending assumptions"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Mock pitch w/ mentors"] },
      { id: "Lab 2", bullets: ["Iterate pitch"] },
    ],
    deliverables: ["Pitch v2"],
    evaluationFocus: [{ metric: "Pitch quality", focus: "Structure & defense" }],
  },
  {
    week: 12,
    semester: "S1",
    title: "Founder Reflection & Iteration",
    sessions: [
      { id: "Session 1", bullets: ["Reflection systems", "Learning loops"] },
      { id: "Session 2", bullets: ["Founder journaling"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Weekly reflection ritual"] },
      { id: "Lab 2", bullets: ["Founder review with mentor"] },
    ],
    deliverables: ["Reflection Log"],
    evaluationFocus: [{ metric: "Self-awareness", focus: "Honest assessment" }],
  },
  {
    week: 13,
    semester: "S1",
    title: "Industry Founder Sessions",
    sessions: [
      { id: "Session 1", bullets: ["Founder case studies"] },
      { id: "Session 2", bullets: ["Failure post-mortems"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Live founder Q&A"] },
      { id: "Lab 2", bullets: ["Write case-study notes"] },
    ],
    deliverables: ["Case Study Notes"],
    evaluationFocus: [{ metric: "Insight extraction", focus: "Application" }],
  },
  {
    week: 14,
    semester: "S1",
    title: "Mid-Semester Founder Review",
    sessions: [
      { id: "Session 1", bullets: ["Review prep", "Evidence packaging"] },
      { id: "Session 2", bullets: ["Review feedback handling"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Full venture review"] },
      { id: "Lab 2", bullets: ["Action plan"] },
    ],
    deliverables: ["Review Deck"],
    evaluationFocus: [{ metric: "Progress", focus: "Tangible execution" }],
  },
  {
    week: 15,
    semester: "S1",
    title: "Final Validation Defense",
    sessions: [
      { id: "Session 1", bullets: ["Defense structure"] },
      { id: "Session 2", bullets: ["Critical Q&A drills"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Mock defense"] },
      { id: "Lab 2", bullets: ["Final defense"] },
    ],
    deliverables: ["Validation Defense Document"],
    evaluationFocus: [{ metric: "Defense quality", focus: "Evidence + clarity" }],
  },
  {
    week: 16,
    semester: "S1",
    title: "Semester Synthesis & Portfolio",
    sessions: [
      { id: "Session 1", bullets: ["Portfolio structure"] },
      { id: "Session 2", bullets: ["Next-semester planning"] },
    ],
    labs: [
      { id: "Lab 1", bullets: ["Compile founder portfolio"] },
      { id: "Lab 2", bullets: ["Plan S2 venture trajectory"] },
    ],
    deliverables: ["Founder Portfolio v1"],
    evaluationFocus: [{ metric: "Portfolio", focus: "Completeness" }],
  },
  ...
  ...quickWeeks("S2", [
    [
      "MVP Philosophy",
      "MVP vs full product, lean basics",
      "Define MVP scope for venture",
      "MVP Scope Doc",
    ],
    [
      "Feature Prioritization",
...
export const RUBRICS = [
  {
    ...
    criteria: [
      {
        level: "Exemplary (9–10)",
        desc: "20+ authentic interviews, deep pattern synthesis, disconfirming evidence collected.",
      },
      {
        level: "Proficient (7–8)",
        desc: "10–20 interviews, clear synthesis, mostly unbiased questioning.",
      },
      {
        level: "Developing (5–6)",
        desc: "<10 interviews, partial synthesis, leading questions present.",
      },
      {
        level: "Insufficient (0–4)",
        desc: "Few/no interviews, no synthesis, fabricated or surface-level data.",
      },
    ],
  },
  {
    ...
    criteria: [
      {
        level: "Exemplary (9–10)",
        desc: "Functional MVP, real users, documented iteration loop, clear hypothesis testing.",
      },
      {
        level: "Proficient (7–8)",
        desc: "Working MVP with some user testing and one iteration cycle.",
      },
      {
        level: "Developing (5–6)",
        desc: "Prototype exists but no real user testing or iteration.",
      },
  ...
  },
  {
    ...
    criteria: [
      {
        level: "Exemplary (9–10)",
        desc: "Consistent execution, accountability, recovery after setbacks.",
      },
      {
        level: "Proficient (7–8)",
        desc: "Steady execution, mostly accountable, some recovery patterns.",
      },
  ...
  },
  {
    ...
    criteria: [
      {
        level: "Exemplary (9–10)",
        desc: "Public launch, multi-channel experiments, retention data, learning loops.",
      },
      {
        level: "Proficient (7–8)",
        desc: "Launched product, 2+ channel experiments, basic analytics.",
      },
...
export const FAILURE_FRAMEWORK = {
  principle:
    "Startup failure ≠ academic failure. Students are evaluated on response to failure, not occurrence of failure.",
  acceptable: [
...
export const RESOURCES = [
  {
    tag: "Case Study",
    title: "Indian Unicorn Teardowns",
    note: "Founder journeys, early traction, pivots.",
  },
  {
    tag: "Case Study",
    title: "Failed Startup Post-Mortems",
    note: "Pattern library of why startups failed.",
  },
  {
    tag: "Case Study",
    title: "Bootstrapped Companies",
    note: "Capital-efficient venture playbooks.",
  },
...
export const FACULTY_RESPONSIBILITIES = [
  {
    role: "Track Lead",
    duties: ["Curriculum ownership", "Outcome mapping", "Rubric integrity", "Faculty coordination"],
  },
  {
    role: "Lecturer",
    duties: ["Concept delivery", "Framework teaching", "Case-study facilitation"],
  },
  {
    role: "Lab Mentor",
    duties: ["Execution supervision", "Iteration coaching", "Review facilitation"],
  },
  {
    role: "Founder Reviewer",
    duties: ["Founder reviews", "Execution audits", "Behavior assessment"],
  },
  {
    role: "Industry Mentor",
    duties: ["Domain expertise", "Real-world feedback", "Network access"],
  },
];
...
export const FOUNDER_OPERATOR_EVAL = {
  ...
  description:
    "Evaluates the student as a real-world founder: how they show up, decide, recover, and ship under uncertainty.",
  dimensions: [
    {
      name: "Ownership",
      indicators: ["Drives venture without prompting", "Owns outcomes", "Closes loops"],
    },
    {
      name: "Execution Cadence",
      indicators: ["Weekly shipped artifacts", "Sprint discipline", "Visible momentum"],
    },
    {
      name: "Decision Quality",
      indicators: ["Evidence-based pivots", "Trade-off clarity", "Time-to-decide"],
    },
    {
      name: "Recovery",
      indicators: ["Post-mortem rigor", "Corrective experiments", "Pattern correction"],
    },
    {
      name: "Founder Communication",
      indicators: ["Investor-grade clarity", "Defense under critique", "Honest reporting"],
    },
  ],
};
...
export const BUILDER_EVAL = {
  ...
  dimensions: [
    {
      name: "MVP Quality",
      indicators: ["Functional core flow", "Real users in loop", "Bug discipline"],
    },
    {
      name: "Iteration Velocity",
      indicators: ["Changelog cadence", "Hypothesis → ship loop", "Cycle time"],
    },
    {
      name: "Technical Reasoning",
      indicators: ["Stack choices justified", "Scope discipline", "Build vs buy"],
    },
    {
      name: "UX & Product Sense",
      indicators: ["Journey clarity", "Friction removal", "Onboarding quality"],
    },
    {
      name: "Validation Rigor",
      indicators: ["Disconfirming evidence", "Cohort discipline", "Signal extraction"],
    },
  ],
};
...
export const KNOWLEDGE_EVAL = {
  ...
  description:
    "Academic-defensible component: concepts, frameworks, vocabulary, BOS/AIAP-aligned assessment.",
  dimensions: [
    { name: "Concept Mastery", indicators: ["Define & apply frameworks", "Cross-case reasoning"] },
    {
      name: "Framework Application",
      indicators: ["Use frameworks in own venture", "Adapt vs misuse"],
    },
...
export const SELECTIVE_ENTRY = {
  ...
  stages: [
    {
      stage: "Application",
      criteria: ["Founder essay", "Past execution evidence", "Time-commitment letter"],
    },
    {
      stage: "Builder Task",
      criteria: ["48-hour problem-discovery task", "Field interview submission", "Synthesis memo"],
    },
    {
      stage: "Founder Interview",
      criteria: ["Motivation depth", "Ambiguity tolerance", "Coachability"],
    },
    {
      stage: "Conditional Offer",
      criteria: ["Probation semester", "Weekly review cadence", "Exit ramp if non-execution"],
    },
  ],
};
...
export const FACULTY_OPERATING_MODEL = {
  ...
  cadence: [
    {
      ritual: "Weekly Studio Review",
      frequency: "Weekly",
      owners: ["Lab Mentor", "Founder Reviewer"],
      purpose: "Execution audit + unblock",
    },
    {
      ritual: "Concept Lecture",
      frequency: "Weekly",
      owners: ["Lecturer"],
      purpose: "Framework + case-based teaching",
    },
    {
      ritual: "Founder Review",
      frequency: "Bi-weekly",
      owners: ["Founder Reviewer", "Industry Mentor"],
      purpose: "Founder behavior + venture trajectory",
    },
    {
      ritual: "Industry Session",
      frequency: "Monthly",
      owners: ["Industry Mentor"],
      purpose: "Domain depth + network access",
    },
    {
      ritual: "Rubric Calibration",
      frequency: "Monthly",
      owners: ["Track Lead", "Lecturer", "Lab Mentor"],
      purpose: "Inter-rater reliability",
    },
    {
      ritual: "Semester Defense Panel",
      frequency: "End of semester",
      owners: ["Track Lead", "Industry Mentor", "External Evaluator"],
...
export const INDUSTRY_INTEGRATION = [
  ...
  {
    phase: "S2",
    touchpoints: ["MVP critique panels", "PM/Designer mentorship", "No-code coaching"],
  },
  {
    phase: "S3",
    touchpoints: ["GTM operator reviews", "Growth teardown sessions", "Distribution mentors"],
  },
  {
    phase: "S4",
    touchpoints: ["Investor simulations", "CFO/Finance mentors", "External defense panel"],
  },
];
