  ...
  weeks: [
    {
      ...
      topics: ["Startup myths", "Founder reality", "Why startups fail", "Execution vs ideas", "Founder psychology", "Ownership mindset"],
    ...
    },
    {
      ...
      topics: ["Problem observation", "Friction mapping", "Opportunity spotting", "Painkiller vs vitamin"],
  ...
  weeks: [
    {
      ...
      tlos: ["TLO-3"], clos: ["CLO-5"],
      evaluation: "Launch readiness", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-3"], clos: ["CLO-5"],
      evaluation: "Acquisition strategy", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-3"], clos: ["CLO-5"],
      evaluation: "Channel selection", mentor: "Internal",
    },
    {
      n: 4,
      title: "Growth Experiments",
      tlos: ["TLO-3"], clos: ["CLO-5"],
      evaluation: "Experiment design", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-3", "TLO-4"], clos: ["CLO-5"],
      evaluation: "Community traction", mentor: "Internal",
    },
    {
      n: 6,
      title: "Sales Fundamentals",
      tlos: ["TLO-3"], clos: ["CLO-5"],
      evaluation: "Sales motion", mentor: "Internal",
    },
    {
      n: 7,
      title: "Negotiation & Conversion",
      tlos: ["TLO-3", "TLO-5"], clos: ["CLO-5"],
      evaluation: "Conversion outcomes", mentor: "Internal",
    },
    {
      n: 8,
      title: "Mid-Sem Founder Review",
      panel: "NST + TPF + Mentors",
      tlos: ["TLO-3", "TLO-4", "TLO-5"], clos: ["CLO-5", "CLO-6"],
      evaluation: "Founder Review", mentor: "Internal",
      tpf: "External evaluator on review panel",
      evidence: ["Review sheets"],
    },
    {
      ...
      tlos: ["TLO-3", "TLO-6"], clos: ["CLO-6"],
      evaluation: "Metric literacy", mentor: "Internal",
    },
    {
      n: 10,
      title: "Buildathon",
      event: "Product Build Sprint",
      tlos: ["TLO-2", "TLO-4"], clos: ["CLO-6"],
      evaluation: "Build outcomes", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-4"], clos: ["CLO-7"],
      evaluation: "Ops maturity", mentor: "Internal",
    },
    {
      n: 12,
      title: "Startup Finance",
      topics: ["Revenue", "Burn", "Runway"],
      tlos: ["TLO-4", "TLO-6"], clos: ["CLO-7"],
      evaluation: "Financial literacy", mentor: "Internal",
    },
    {
      n: 13,
      title: "Fundraising Fundamentals",
      tlos: ["TLO-6"], clos: ["CLO-8"],
      evaluation: "Fundraising readiness", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-5", "TLO-6"], clos: ["CLO-8"],
      evaluation: "Investor narrative", mentor: "Internal",
    },
    {
      n: 15,
      ...
      tlos: ["TLO-5", "TLO-6"], clos: ["CLO-8"],
      evaluation: "Pitch readiness", mentor: "Internal",
    ...
    },
    {
      ...
      tlos: ["TLO-3", "TLO-4", "TLO-5", "TLO-6"], clos: ["CLO-5", "CLO-6", "CLO-7", "CLO-8"],
      evaluation: "Final venture evaluation", mentor: "Internal",
      tpf: "Demo Day panelist & ecosystem feedback",
...
export function semesterHealth(s: Semester) {
  ...
  const founderReviews = s.weeks.filter(w => /founder review|demo day/i.test(w.title) || /founder review/i.test(w.evaluation || "")).length;
